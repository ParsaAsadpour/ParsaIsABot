...
module.exports.run = async(bot, message, args) => {
    ...
    var places = ['Your Pocket','Floor','fridge','Under Carpet','Kitchen','Laundromat','Bus','Car','Tree','Airport'];
    ...
    message.reply(`You Searched ${places[place]} and Found **${amounts[amount]}**`)
